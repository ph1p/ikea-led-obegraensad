...
private:
  ...
  uint8_t paddleIndex = 230, ballX = 112, ballY = 208, ballIndex = 216, ballBrightness = 255,
          ballBrightnessStep = -20,

          pongPaddleLeftY = 0, pongPaddleRightY = 0, pongPaddleLeftStart = 0,
          pongPaddleRightStart = 0, pongPaddleLeftTarget = 0, pongPaddleRightTarget = 0;

  bool pongScoredHour = false, pongScoredMinute = false, pongCelebrate = false,
       pongclock = false, // pong clock mode
      pongReset = false, pongBallDirection = 0;

  unsigned long pongCelebrationEnd = 0, pongShowtime = 0, nextUpdateMillis = 0;
